            ...
            <?php foreach ($formations as $formation) : ?>
                <li>
                    ...
                    <div class="formation-info">
                        ...
                        <form action="../controleur/AjoutAvisConfirme.php" method="post">
                            <label for="Commentaire"> Commentaire: </label>
                            <textarea name="Commentaire" rows="4" cols="85"></textarea>
                            <input type="hidden" name="formation_id" value="<?= $formation['id_formation'] ?>">
                            <button type="submit" class="signalement-btn">Ajouter le commentaire </button>
                        </form>
